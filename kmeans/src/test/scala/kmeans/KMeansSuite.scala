...
class KMeansSuite {
  ...
  @Test def `'classify' with data parallelism should work for empty 'points' and 'means' == ParSeq(Point(1,1,1))`(): Unit = {
  ...
  @Test def `'classify' with data parallelism should work for 'points' == ParSeq((1, 1, 0), (1, -1, 0), (-1, 1, 0), (-1, -1, 0)) and 'means' == ParSeq((0, 0, 0))`(): Unit = {
    val p1 = new Point(1, 1, 0)
    val p2 = new Point(1, -1, 0)
    val p3 = new Point(-1, 1, 0)
    val p4 = new Point(-1, -1, 0)
    val points: ParSeq[Point] = ParSeq(p1, p2, p3, p4)
    val mean = new Point(0, 0, 0)
    val means: ParSeq[Point] = ParSeq(mean)
  ...
  @Test def `'classify' with data parallelism should work for 'points' == ParSeq((1, 1, 0), (1, -1, 0), (-1, 1, 0), (-1, -1, 0)) and 'means' == ParSeq((1, 0, 0), (-1, 0, 0))`(): Unit = {
    val p1 = new Point(1, 1, 0)
    val p2 = new Point(1, -1, 0)
    val p3 = new Point(-1, 1, 0)
    val p4 = new Point(-1, -1, 0)
